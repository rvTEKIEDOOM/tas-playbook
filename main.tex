...
\usepackage{setspace}
\usepackage{enumitem}
\usepackage{tcolorbox} % For email formatting
...
% ---------- Logo ----------
\begin{center}
\includegraphics[width=0.5\textwidth]{TekieGeekLogo.png} \\
\vspace{0.5cm}
{\LARGE \textbf{Technical Alignment Superhero (TAS) Standard Operating Procedures}}
\end{center}
...
% Activate shared TAS page style (page number at top, version in footer)
\pagestyle{tasfooter}
